...
class ProductNotificationMessageHandler
{
    ...
    protected function handleMapTenantProductToProviderMessageBase(MappingNotificationMessage $message, ?bool $sync = false): void
    {
    ...
    #[AsMessageHandler(fromTransport: MessageTransports::MAP_TENANT_PRODUCT_TO_PROVIDER)]
    ...
    protected function handleSendTenantProductToProviderMessageBase(MappingNotificationMessage $message, $sync = false): void
    {
...
//            if request succeeded clear provider body
    ...
    #[AsMessageHandler(fromTransport: MessageTransports::SEND_TENANT_PRODUCT_TO_PROVIDER)]
    ...
    protected function handleMapProviderProductToTenantMessageBase(MappingNotificationMessage $message, ?bool $sync = false): void
    {
    ...
    #[AsMessageHandler(fromTransport: MessageTransports::MAP_PROVIDER_PRODUCT_TO_TENANT)]
    ...
    protected function handleSendProviderProductToTenantMessageBase(MappingNotificationMessage $message, $sync = false): void
    {
...
//            if request succeeded clear provider body
    ...
    #[AsMessageHandler(fromTransport: MessageTransports::SEND_PROVIDER_PRODUCT_TO_TENANT)]
